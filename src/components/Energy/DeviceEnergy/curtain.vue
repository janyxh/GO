<template>
  <el-col class="lis" :class="{ 'on':item.value1==0,'off':item.value1==1,'stop':item.value1!=0&&item.value1!=1, }">
    ...
    <el-row class="switch" type="flex" justify="center">
      <el-col class="switchBtn" :span="16">
        <el-button size="small" @click="openDevice(item,getList)" :class="{'el-button--primary':item.value1==0}">开启</el-button>
        <el-button size="small" @click="stopDevice(item,getList)" :class="{'el-button--primary':item.value1!=0&&item.value1!=1}">停止</el-button>
...
<style lang="scss" scoped>
  .lis {
    ...
    &.on{
      ...
      .picWrap{
        .picture{
          background: url("../../../assets/img/icon_curtain_on_p.png") no-repeat center center;
        }
      }
    }
    &.stop{
      ...
      .picWrap{
        .picture{
          background: url("../../../assets/img/icon_curtain_off1.png") no-repeat center center;
        }
      }
    }
    &.off{
      ...
      .picWrap{
        .picture{
          background: url("../../../assets/img/icon_curtain_off.png") no-repeat center center;
        }
      }
      .switch{
        .switchBtn{
