  ...
  <el-col class="lis" :class="item.value1 ? 'off' : 'on'">
    ...
    <el-row class="model">
      ...
      <el-col :span="15" class="btn" >
        <el-button size="small" :disabled="!!item.value1" @click="refrigerate(item,getList)" :class="{'el-button--primary':item.mode==1}">制冷</el-button>
        <el-button size="small" :disabled="!!item.value1" @click="heating(item,getList)" :class="{'el-button--primary':item.mode==4}">制热</el-button>
        <el-button size="small" :disabled="!!item.value1" @click="airExhaust(item,getList)" :class="{'el-button--primary':item.mode==3}">排风</el-button>
      </el-col>
    </el-row>
    <el-row class="speed">
      ...
      <el-col :span="15" class="btn" >
        ...
        <el-button size="small" :disabled="!!item.value1" @click="tempBig(item,getList)" :class="{'el-button--primary':item.innerFanSpeed==5}">大</el-button>
        <el-button size="small" :disabled="!!item.value1" @click="tempMiddle(item,getList)" :class="{'el-button--primary':item.innerFanSpeed==3}">中</el-button>
        <el-button size="small" :disabled="!!item.value1" @click="tempSmall(item,getList)" :class="{'el-button--primary':item.innerFanSpeed==1}">小</el-button>
      </el-col>
    </el-row>
  </el-col>
</template>
